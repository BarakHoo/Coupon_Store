            ...
            try {
                ...
                if (selectedCategory !== null) {
                    if (maxPrice > 0) {
                        ...
                        coupons = await customerService.getCustomerCouponsByCategoryAndMaxPrice(maxPrice, selectedCategory);
                    } else {
                        // Fetch coupons based on category only
                        coupons = await customerService.getCustomerCouponsByCategory(selectedCategory);
                    }
                } else if (maxPrice > 0) {
                    // Fetch coupons based on max price only
                    coupons = await customerService.getCustomerCouponsByPrice(maxPrice);
                } else {
